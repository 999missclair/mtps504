...
(function () {
  ...
  var DECK = {
    ...
    situation: [
      ...
      { id: 's4',  label: 'The label has the wrong name',         searchTerm: 'museum exhibit label',          thumb: 'Openverse — "Museum Exhibition Label Piece" (CC BY)' },
      ...
      { id: 's6',  label: 'A famous artwork arrives on loan',     searchTerm: 'crowd viewing painting gallery', thumb: 'Openverse — "NYC — Metropolitan Museum of Art: At the Lapin Agile"' },
      ...
      { id: 's10', label: 'The gift shop is out of postcards',    searchTerm: 'postcard rack',                 thumb: 'Commons — Postcard rack in Thun' },
